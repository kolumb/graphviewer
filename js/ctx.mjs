class Ctx {
    ...
    static quadraticCurveTo(controlPoint, endPos) {
        Ctx.ctx.quadraticCurveTo(controlPoint.x, controlPoint.y, endPos.x, endPos.y);
    }
    static bezierCurveTo(controlPoint1, controlPoint2, endPos) {
        Ctx.ctx.bezierCurveTo(controlPoint1.x, controlPoint1.y, controlPoint2.x, controlPoint2.y, endPos.x, endPos.y);
    }
    ...
    static arcTo(controlPoint1, controlPoint2, radius) {
        Ctx.ctx.arcTo(controlPoint1.x, controlPoint1.y, controlPoint2.x, controlPoint2.y, radius);
    }
    static ellipse(pos, radius, rotation, startAngle, endAngle, counterclockwise) {
        Ctx.ctx.ellipse(pos.x, pos.y, radius.x, radius.y, rotation, startAngle, endAngle, counterclockwise);
    }
