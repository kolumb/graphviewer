...
class Graph {
    ...
    static serialize() {
        ...
        result += Graph.nodes
            ...
            return `    node${node.id} [x=${x}, y=${y}, label="${node.label
                .replaceAll("\\", "\\\\")
                .replaceAll('"', '\\"')}"]`;
        })
            .join(";\n");
    ...
    static deserialize(text) {
        ...
        for (let i = 1; i < lines.length - 1; i++) {
                    ...
                    case states.trim:
                        switch (c) {
                            ...
                            case '"':
                                ...
                                break;
                            case "-":
                                assert(connectionType === ConnectionTypes.undefined, id1 === ""
            ...
            assert(currentState == states.trim ||
                currentState == states.attributesOrSeparator, "Unexpected state after deserialization " + currentState);
