...
class Graph {
          ...
          case states.separator:
            switch (c) {
              ...
              case ";":
                assert(
                  false,
                  "Unfinished separator (supported connections are -- and -> )"
                );
                break;
              default:
                assert(
                  false,
                  "Invalid separator. Expected -- or -> or attributes list in [ ]"
                );
            }
            break;
          case states.string:
  ...
  static parseAttributes(id: string, attributes: string) {
